...
export function OfferCard({ offer }: OfferCardProps) {
  ...
  return (
    <div className="group relative bg-slate-900/40 backdrop-blur-md border border-slate-800/50 rounded-3xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-indigo-500/20 hover:border-indigo-500/30 hover:-translate-y-1 flex flex-col">
      ...
      <div className="relative aspect-square w-full overflow-hidden bg-slate-800/50">
        ...
        <div className="absolute top-3 right-3 bg-slate-950/80 backdrop-blur-md px-3 py-1.5 rounded-full border border-slate-700/50 text-indigo-300 text-xs font-semibold shadow-xl">
      ...
      <div className="p-5 flex flex-col grow gap-3 relative z-10">
        <div className="flex justify-between items-start gap-2">
          <h3 className="text-lg font-bold text-slate-100 leading-tight group-hover:text-indigo-300 transition-colors line-clamp-2">
            {offer.title}
          </h3>
        </div>
        
        <div className="flex items-center text-slate-400 text-sm mt-auto gap-1.5">
        ...
        <div className="pt-3 border-t border-slate-800/60 mt-2 flex items-baseline gap-1">
